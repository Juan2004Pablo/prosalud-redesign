  ...
  return (
    <div className="mb-6 p-6 border rounded-lg shadow-sm bg-white">
      ...
      <p className="text-base text-gray-700">
        Teniendo en cuenta la importancia de esto para varios procesos administrativos, contables, de seguridad social y de SST relacionados con el contrato sindical. Por lo tanto, le invitamos a leer y tener en cuenta el siguiente instructivo para cuando tenga lugar.
      </p>
    </div>
  );
};

export default InformacionGeneralRetiroSection;
