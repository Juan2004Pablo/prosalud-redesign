...
const MissionVisionSkeletonCard: React.FC = () => (
...
const MissionVisionSkeleton: React.FC = () => (
  <section className="py-12 sm:py-16 md:py-24 bg-background-light">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-stretch">
        <MissionVisionSkeletonCard />
        <MissionVisionSkeletonCard />
      </div>
    </div>
  </section>
...
const MissionVisionSection: React.FC = () => {
  ...
  return (
    <div ref={observerRef} className="min-h-[1px]">
      {isVisible ? <MissionVisionContent /> : <MissionVisionSkeleton />}
    </div>
  );
};
