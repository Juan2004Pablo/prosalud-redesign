  ...
  return (
    <header className="mb-8 text-center">
      ...
      <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">
        Complete el siguiente formulario para solicitar su certificado de convenio sindical. Una vez procesada su solicitud, el certificado será enviado al correo electrónico que registre en los próximos días hábiles.
      </p>
    </header>
  );
};
