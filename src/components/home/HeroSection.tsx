...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-primary-prosalud via-primary-prosalud-dark to-slate-900 text-text-light section-spacing">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left Column: Textual Content & Buttons */}
          <div className="md:text-left text-center content-spacing">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-10 animate-fade-in animation-delay-100 max-w-2xl mx-auto md:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-6 md:justify-start justify-center animate-fade-in animation-delay-200">
              <Button
                size="lg"
                className="bg-secondary-prosaludgreen hover:bg-secondary-prosaludgreen-dark text-text-light px-8 py-3 btn-press hover-lift"
                onClick={handleScrollToQuickLinks}
                aria-label="Ir a la sección de gestión de trámites"
              >
              ...
              <Link to="/nosotros/quienes-somos">
                <Button
                  variant="outline"
                  size="lg"
                  className="text-text-light border-text-light hover:bg-white/10 px-8 py-3 hover:text-white w-full sm:w-auto btn-press"
                  aria-label="Conocer más sobre ProSalud"
                >
                  Conócenos Más
                </Button>
              </Link>
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-slate-800/30 rounded-xl shadow-xl">
              {[
                ...
                <img
                  key={index}
                  src={src}
                  alt={`Profesional de la salud en ambiente laboral ${index + 1}`}
