...
const GaleriaBienestarIntroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <p className={`max-w-lg mx-auto text-muted-foreground mt-2 mb-8 transition-all duration-500 ease-out delay-200 ${mounted && isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      ...
      >
        <div className="flex justify-center" style={{ transformStyle: 'preserve-3d', transform: 'rotateX(5deg)' }}>
          {galleryImages.map((img, index) => {
            ...
            const centerBackwardOffset = 70; 
            const edgeForwardOffset = 20;   
            const sideImageScaleBoost = 0.15; 
            ...
            return (
              <div
                ...
                style={{
                  ...
                  margin: '0 2px', // Espaciado de 2px a cada lado, total 4px entre imágenes
                  zIndex: zIndexVal 
                }}
              >
                <div 
