...
const newServices: Service[] = [
  ...
  { icon: CalendarCheck, title: 'Solicitud de descanso', description: 'Solicita días de descanso según tus condiciones actuales.', linkTo: '/servicios/descanso-laboral', category: 'Gestión Personal y Laboral' },
