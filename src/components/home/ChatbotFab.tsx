      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            className="fixed bottom-6 right-6 w-16 h-16 bg-prosalud-salud hover:bg-prosalud-salud/90 rounded-full shadow-xl animate-pulse z-50 flex items-center justify-center"
