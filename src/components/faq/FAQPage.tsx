              ...
              <Button
                ...
                className={`transition-colors ${
                  selectedCategory === 'all'
                    ? 'bg-primary-prosalud text-white hover:bg-primary-prosalud-dark'
                    : 'border-primary-prosalud text-primary-prosalud hover:bg-prosalud-light'
                }`}
              >
                  ...
                  <Accordion type="multiple" className="space-y-4">
                    {items.map((faq) => (
                      <AccordionItem
                        key={faq.id}
                        value={faq.id}
                        className="border border-gray-200 rounded-lg bg-prosalud-light hover:bg-white transition"
                      >
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-100">
                            <div className="flex flex-wrap gap-2">
                              {faq.keywords.slice(0, 5).map((keyword, index) => (
                                <Badge
                                  key={index}
                                  className="bg-prosalud-light text-primary-prosalud-dark text-xs border border-primary-prosalud"
                                >
                                  {keyword}
                                </Badge>
                              ))}
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button variant="secondary" size="sm" className="bg-secondary-prosaludgreen text-white hover:bg-secondary-prosaludgreen-dark">
                    Usar Chatbot
                  </Button>
                  <Button
                    variant="outline"
                    size="sm"
                    className="text-white border-white hover:bg-white hover:text-primary-prosalud"
                  >
                    Ver Servicios
                  </Button>
                </div>
