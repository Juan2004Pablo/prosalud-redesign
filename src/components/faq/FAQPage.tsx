            ...
            <div className="relative mb-8 max-w-2xl mx-auto">
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-12 pr-6 py-4 text-lg rounded-2xl border-0 shadow-xl bg-white/95 backdrop-blur-sm focus:bg-white focus:ring-2 focus:ring-white/50 transition-all"
                />
              </div>
            </div>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link to="/">
                    <Button 
                      variant="outline" 
                      size="lg"
                      className="text-white border-white/50 hover:bg-white/10 hover:border-white font-semibold rounded-lg transition-all hover:scale-105"
                    >
